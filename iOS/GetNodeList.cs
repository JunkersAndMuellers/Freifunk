...
[assembly: Xamarin.Forms.Dependency(typeof(GetNodeList_iOS))]

namespace FFStraelen.iOS
{
    public class GetNodeList_iOS:FFStraelen.IGetNodeList
    {
        public GetNodeList_iOS()
        { 
        }
        ...
        public List<Freifunk.FFRecord> GetCompleteNodeList()
        {
            ...
            //FFServiceSoapClient sc = new FFServiceSoapClient("FFServiceSoap");
            //FFRecord[] ffr = sc.GetCompleteNodeData();
            return fflist;
        }
